<!-- Vista de Todos los prestamos de suministro-->
<div class="upside">
    <a href="index.php" class="Inicio">« Inicio</a>
</div>
<div class="card" id="ListaCompleta">
    <div class="card-title">
        <h2>PRESTAMOS DE SUMINISTRO</h2>
    </div>
    <div class="card-subtitle" id="Add">
        ...
        <select class="form-select-sm" name="forma" onchange="location = this.value;">
            ...
            <option value="?c=detalleAllPrestamoSuministro"selected>Préstamo de Suministro</option>
        </select>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-funnel-fill" viewBox="0 0 16 16">
        <path d="M1.5 1.5A.5.5 0 0 1 2 1h12a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.128.334L10 8.692V13.5a.5.5 0 0 1-.342.474l-3 1A.5.5 0 0 1 6 14.5V8.692L1.628 3.834A.5.5 0 0 1 1.5 3.5v-2z"/>
        </svg>
        <a href="?c=crearPrestamoSuministro" class="add">
    ...
    <table class="table">
        ...
        <tbody>
        <?php
        foreach ($allPrestamoSuministro as $value) {    
        ?>
            <tr>
                <td scope="row"><?php echo $value->idPrestamoSuministro; ?></td>
                <td scope="row"><?php echo $value->idPrestamo; ?></td>
                ...
                <?php foreach ($allEstadoDevolucion as $estado) { if ($value->idEstadoDevolucion  == $estado->idEstadoDevolucion) {?>
                    <td scope="row"><?php echo $estado->descripcionEstadoDevolucion; ?></td>
                <?php } }  ?>
                <td scope="row">
                <a class="ver" id="ver" href="?c=detallePrestamoSuministro&idPrestamoSuministro=<?php echo $value->idPrestamoSuministro; ?>">
                <!-- Icono Info -->
