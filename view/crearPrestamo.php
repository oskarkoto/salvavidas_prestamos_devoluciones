    ...
    <form method="POST" action="?c=crearPrestamo" class='formulario'>        
        <div class="form-group" align="center" >
            <div class="col-md-12 col-xl-12 col-sm-12" >
                ...
                <input type="number" class="col-sm-2 col-form-label" id="input_form" name="idPrestamo" placeholder="ID de Préstamo" required>
            </div>                
        ...
        <div class="form-button" align="center" >
            <button type="submit" class="btn btn-primary boton-form" id="submit-button">Agregar Préstamo</button>
        </div>
    </form>
</div>