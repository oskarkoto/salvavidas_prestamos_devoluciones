...
<div class="card" id="ListaCompleta">
    ...
    <div class="card-subtitle" id="Add">
        ...
        <a href="?c=crearTipoReporte" class="add">
    ...
    <table class="table" id="table">
        ...
        ?>
            <tr>
                ...
                <td style="width: 30%;">
                <a class="ver" id="verR" href="?c=detalleTipoReporte&idTipoReporte=<?php echo $value->idTipoReporte; ?>">
                <!-- Icono Ver -->
                ...
                <br>
                <a class="editar" id="editarR" href="?c=actualizarTipoReporte&idTipoReporte=<?php echo $value->idTipoReporte; ?>">
                <!-- Icono Actualizar -->
                ...
                <br>
                <a class="eliminar" id="eliminarR" href="?c=eliminarTipoReporte&idTipoReporte=<?php echo $value->idTipoReporte; ?>">
                <!-- Icono Eliminar -->
