...
<div class="card" id="ListaCompleta">
    ...
    <div class="card-subtitle" id="Add">
        ...
        <select name="forma" onchange="location = this.value;">
            <option value="?c=detalleAllDevolucion" selected>Devolución</option>
        ...
        <a href="?c=crearDevolucion" class="add">
    ...
    <table class="table">
        ...
        ?>
            <tr>
                ...
                <a class="eliminar" id="eliminar" href="?c=eliminarDevolucion&idDevolucion=<?php echo $value->idDevolucion; ?>">
                <!-- Icono Eliminar -->
