    ...
    <form method="POST" action="?c=crearPrestamoEquipo" class='formulario'>        
        <div class="form-group" align="center" >
            <div class="col-md-12 col-xl-12 col-sm-12" >
                ...
                <input type="number" class="col-sm-2 col-form-label" id="input_form" name="idPrestamoEquipo" value="<?php echo $id->idPrestamoEquipo+1; ?>" style="background-color:#f8f8f8; border-color: #d0d0d0" readonly>
                <?php } ?>
            </div>                
