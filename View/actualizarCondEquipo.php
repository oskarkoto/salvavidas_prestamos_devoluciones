...
<div class="card" id="ListaCompleta">
    ...
    <form method="POST" action="?c=actualizarCondEquipo" class='formulario'>       
        ...
        <div class="col-md-12 col-xl-12 col-sm-12" >
            ...
            <div class="col-md-12 col-xl-12 col-sm-12" >
                ...
                <select class="col-sm-2 col-form-label" name="idTipoEquipo" id="input_form" style="background-color:#f8f8f8; border-color: #d0d0d0" readonly>
